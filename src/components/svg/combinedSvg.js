...
const IconAlert = ({ stroke, fill, ...props }) => (
  <g stroke={stroke || '#000'} fill={fill || 'none'} {...props}>
		<path fill="none" stroke-miterlimit="10" d="M4.028,22.497c-3.135,0-4.418-2.222-2.85-4.937L9.158,3.737 c1.568-2.715,4.133-2.715,5.7,0L22.84,17.56c1.568,2.715,0.285,4.937-2.85,4.937H4.028z" />
