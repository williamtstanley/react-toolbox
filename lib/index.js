...
var Tooltip = function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function renderElement() {
      ...
      var className = tip.props.className;

      return _react2.default.cloneElement(tip, { className: (className ? className + ' ' : '') + 'tool-tip-container' });
    }
  }, {
    key: 'render',
...
List.PropTypes = {
  ...
  listType: _propTypes2.default.oneOf(['ol', 'ul']).isRequired };
