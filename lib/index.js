...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(4),p=__webpack_require__(9);__webpack_require__(1);var r=__webpack_require__(2);
...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function cloneWithChange(child) {
      var clonedChild = (0, _elements.clone)(child, { onChange: this.handleChange });

      if (typeof child.type === 'function' && (0, _helpers.getStringType)(child) === 'Input') {
        return clonedChild;
      }
      if ((0, _helpers.getStringType)(child) === 'input') {
        return clonedChild;
      }
      // if (child.type === 'input') {
